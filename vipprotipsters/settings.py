"""
Django settings for vipprotipsters project.
...
ROOT_URLCONF = 'vipprotipsters.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tips.context_processor.globals'
            ],
        },
    },
]

WSGI_APPLICATION = 'vipprotipsters.wsgi.application'
...
CSV_STATIC_URL = str(BASE_DIR) + '\static\csv\\'
PAID_CSV_STATIC_URL = str(BASE_DIR) + f'\static\paid\\'
RESULT_CSV_STATIC_URL = str(BASE_DIR) + f'\static\\result\\'
NO_OF_CSV_ALLOWED = 30
MINIMUM_ODDS = "2.7"

#____________________ ADMIN ________________________
